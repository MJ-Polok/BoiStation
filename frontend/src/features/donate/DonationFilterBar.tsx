import { donationCategories, donationLocations } from './data/donationPosts';

type DonationFilterBarProps = {
    category: string;
    location: string;
...
const DonationFilterBar = ({
    ...
    return (
        <div className="sticky top-0 z-30 border-y border-[#D6CCBA] bg-[#FAF7EF]/92 px-4 py-4 shadow-[0_10px_30px_rgba(17,24,39,0.07)] backdrop-blur sm:px-6 lg:px-8">
            <div className="mx-auto grid max-w-7xl gap-3 md:grid-cols-[240px_240px_auto]">
                <label>
